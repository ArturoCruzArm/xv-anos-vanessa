...
class WhatsAppSender {
    ...
    pathToLabel(path) {
        ...
        const labels = {
            // Banquete
            'foro7.banquete.numeroPersonas': 'Número de personas',
            'foro7.banquete.costoPorPersona': 'Costo por persona',
            'foro7.banquete.menu.entradas': 'Menú - Entradas',
            'foro7.banquete.menu.platoFuerte': 'Menú - Plato fuerte',
            'foro7.banquete.menu.bebidas': 'Menú - Bebidas',
            'foro7.banquete.menu.postres': 'Menú - Postres',
            'foro7.banquete.menu.menuVegetariano': 'Menú vegetariano disponible',
            'foro7.banquete.menu.menuSinGluten': 'Menú sin gluten disponible',
            'foro7.banquete.menu.menuNinos': 'Menú para niños',
            'foro7.banquete.restricciones': 'Restricciones alimenticias',
            'foro7.banquete.notasAdicionales': 'Notas adicionales',

            // Música
            'foro7.musica.costo': 'Costo del servicio',
            'foro7.musica.horarioInicio': 'Horario inicio',
            'foro7.musica.horarioFin': 'Horario fin',
            'foro7.musica.playlist.valsPadre': 'Vals con el padre',
            'foro7.musica.playlist.valsSorpresa': 'Vals sorpresa',
            'foro7.musica.playlist.chambelanes': 'Vals chambelanes',
            'foro7.musica.playlist.entradaQuinceañera': 'Entrada de la quinceañera',
            'foro7.musica.playlist.musicaRecepcion': 'Música de recepción',
            'foro7.musica.playlist.generosFiesta': 'Géneros para la fiesta',
            'foro7.musica.playlist.noReproducir': 'No reproducir',
            'foro7.musica.instruccionesEspeciales': 'Instrucciones especiales',

            // Decoración
            'foro7.decoracion.costo': 'Costo del servicio',
            'foro7.decoracion.colores.principal': 'Color principal',
            'foro7.decoracion.colores.secundario': 'Color secundario',
            'foro7.decoracion.colores.acento': 'Color de acento',
            'foro7.decoracion.tema': 'Tema decorativo',
            'foro7.decoracion.conceptoDecorativo': 'Concepto decorativo',
            'foro7.decoracion.notasEspeciales': 'Notas especiales',

            // Fotografía
            'foro7.fotografia.paquete': 'Paquete seleccionado',
            'foro7.fotografia.costo': 'Costo del servicio',
            'foro7.fotografia.detalles.fechaSesionPreEvento': 'Fecha sesión pre-evento',
            'foro7.fotografia.detalles.estiloFotografico': 'Estilo fotográfico',
